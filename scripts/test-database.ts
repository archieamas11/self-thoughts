...
async function testDatabase() {
  try {
      ...
      const sampleEntries = [
        {
          ...
          content:
            'This is your first journal entry! You can write about anything here - your thoughts, feelings, daily experiences, or dreams for the future. Happy journaling! 🌟',
        ...
        },
        {
          ...
          content:
            "Today I took some time to reflect on my goals and what makes me grateful. It's amazing how writing can help clarify our thoughts and feelings.",
        ...
        },
        {
          ...
          content:
            'This entry is just for testing the archive functionality. When you long-press on an entry, you can archive it!',
    ...
    console.log(
      `🎉 Database test complete! Total entries: ${finalEntries.length}`
    );
